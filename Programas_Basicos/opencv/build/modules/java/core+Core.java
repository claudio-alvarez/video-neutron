...
public class Core {
    ...
    public static final String VERSION = "2.4.6.1", NATIVE_LIBRARY_NAME = "opencv_java246";
    public static final int VERSION_EPOCH = 2, VERSION_MAJOR = 4, VERSION_MINOR = 6, VERSION_REVISION = 1;
    ...
    //javadoc: gemm(src1, src2, alpha, src3, gamma, dst, flags)
    ...
    //javadoc: gemm(src1, src2, alpha, src3, gamma, dst)
